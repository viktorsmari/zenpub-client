...
for file in cpub-merge-from-upstream.sh cpub-merge-from-branch.sh README.md GETTING-STARTED.md env.example .env.secrets.example docker-compose.yml docker-compose.pi.yml .gitlab-ci.yml public/index.html
do
    git reset HEAD ${file}
    git checkout -- ${file}
done
