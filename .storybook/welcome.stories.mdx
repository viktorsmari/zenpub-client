...
# 👋 ZenPub Design Library: Welcome!


Welcome to the Design Library. This area is designed to help: 
* Designers
* Developers
* Administrators

...and anyone interested in configuring or contributing the app!
...
The client connects to a graphql endpoint to perform queries and mutation over the database. 
In order to launch locally the client, you’ll need a running backend. [Here](https://github.com/dyne/zenpub/blob/develop/HACKING.md) you will find a detailed documentation about how to run the backend locally (manually or with docker).
...
##### Get the code
`git clone https://github.com/dyne/zenpub-client.git zenpub`
...
Currently it is translated in the following languages: 
