...
In order to launch locally the client, you’ll need a running backend. [Here](https://gitlab.com/moodlenet/backend/-/blob/develop/HACKING.md) you will find a detailed documentation about how to run the MoodleNet backend locally (manually or with docker).
