...
export const communityProps = {
      community: {
        ...
        canModify: true,
        following: true,
        icon: 'https://home.next.moodle.net/uploads/01DZK8YWM9PZCDG9YP20509C73/triangles.jpeg',
        name: 'Instructional Design in HE',
        fullName: 'he@home.next.moodle.net',
        summary: 'Come and share your top tips and resources for designing awesome learning experiences!',
        totalMembers: 193,
        toggleJoin: {
