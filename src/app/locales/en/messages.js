/* eslint-disable */ module.exports = {
  ...
  messages: {
    ...
    'Browse this MoodleNet instance': 'Browse this MoodleNet instance',
    Cancel: 'Cancel',
    ...
    'Error loading the sidebar': 'Error loading the sidebar',
    ...
    'Is it not possible to show the collection':
      'Is it not possible to show the collection',
    'Is it not possible to show the thread':
      'Is it not possible to show the thread',
    Join: 'Join',
    'Join MoodleNet': 'Join MoodleNet',
    ...
    'eg. moodlerMary': 'eg. moodlerMary',
    in: 'in',
    'to add a resource': 'to add a resource',
    '{0}': function(a) {
      return [a('0')];
    },
    '{0} a collection in': function(a) {
      return [a('0'), ' a collection in'];
    },
    '{0} a community': function(a) {
      return [a('0'), ' a community'];
    },
    '{0} a resource': function(a) {
      return [a('0'), ' a resource'];
    },
    '{INSTANCE_DESCRIPTION}': function(a) {
      return [a('INSTANCE_DESCRIPTION')];
    },
    '{error}': function(a) {
      return [a('error')];
    }
